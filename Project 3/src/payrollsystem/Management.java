...
/**
 * This class is used as an abstract data type to represent a full time employee
 * with management rights and it extends full time
 * 
...
public class Management extends Fulltime {
	 ...
	 * the full time employee instance and it calculates the additional compensation
	...
	/**
	 * Used to calculate the Payment of the full time employee with management
	 * rights
	 */
	@Override
	...
	/**
	 * Checks if two management objects are equal by comparing their profiles, and
	 * it call the super class if the Object is not management type
	 * 
	...
	/**
	 * Creates a string consisting of name::department::date
	 * hired::payment::salary::additional compensation
	 * 
	 ...
	 * 
	 * @return returns an 1,2,3 depending on the role of the employee 1 - MANAGER
	 *         SALARY 2 - DEPARTMENT HEAD SALARY 3 - DIRECTOR SALARY
	 */
	...
	/**
	 * Used in junit test class to test the compensation of each employee once
	 * calculate payment is called
	 * 
