...
/**
 * This class is used as an abstract data type to represent the profile of an
 * employee it contains the name,department and date hired
 * 
...
public class Profile {
	...
	/**
	 * Checks if two profile objects are equal by comparing their name,department
	 * and date hired
	 * 
