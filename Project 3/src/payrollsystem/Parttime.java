...
/**
 * This class is used as an abstract data type to represent a part time employee and it extends Employee
 * 
...
public class Parttime extends Employee {
	 ...
	 * an hourly rate to the employee instance
	 */
	...
	/**
	 * CONSTRUCTOR: Creates a new object with a new profile containing Name,date Hired,Department by calling the super constructor and it assigns
	 * a number to the hours worked by the employee
	 */
	 ...
	 * @return returns an integer representing the hours worked by the employee in the instance
	 * 
	 */
	public int getHours() {
	 ...
	 * @return returns an float representing the hourly rate of the employee in the instance
	 * 
	 */
	...
	/**
	 * Checks if two part time objects are equal by comparing their profiles, and it call the super class if the Object is not part time type
	...
	/**
	 * Creates a string consisting of name::department::date hired::payment::hourly rate::hours worked
