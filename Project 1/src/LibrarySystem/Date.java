...
public class Date {
	...
	public Date() {
		...
		this.month=Calendar.getInstance().get(Calendar.MONTH) + 1 ;//January is returned as 0, so we have to add one to the value return by Calendar.MONTH.
	...
	*/
	public boolean isValid() {
		...
		switch(month) {//Checks if the date is in the correct range for the month being stored in instance.
